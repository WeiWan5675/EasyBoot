...
public class DefaultCodeMsgBundle {
    ...
    public static final CodeMsg UNKNOWN = new CodeMsg("90000", "未知异常，请联系管理员,%s");
    public static final CodeMsg PARAM_INVALID = new CodeMsg("90001", "参数错误,%s");
    public static final CodeMsg PARAM_BIND_ERROR = new CodeMsg("90002", "参数绑定错误,%s");
