...
import com.weiwan.easyboot.mapper.SysFileMapper;
...
public class SysFileService extends AbstractCrudService<SysFileMapper, SysFile, String> {
    ...
    public List<SysFile> findByIds(@NotEmpty List<String> ids) {
        ...
        sysFileQuery.setIds(ids);
        return this.find(sysFileQuery);
    }
