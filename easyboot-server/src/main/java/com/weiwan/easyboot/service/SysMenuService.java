...
import com.weiwan.easyboot.mapper.SysMenuMapper;
...
import com.weiwan.easyboot.model.entity.SysMenuQuery;
...
@Service
public class SysMenuService extends AbstractCrudService<SysMenuMapper, SysMenu, Integer> {
    ...
    public List<SysMenu> findTreeTable() {
        List<SysMenu> sysMenus = this.find(new SysMenuQuery());
    ...
    public int delete(@NotNull @Min(1) Integer id) {
        ...
        childrenIds.add(id);
        Integer[] menuIds = childrenIds.toArray(new Integer[]{});
    ...
    public List<SysMenu> findAllChildren(@NotNull Integer id) {
        SysMenuQuery sysMenuQuery = new SysMenuQuery();
        sysMenuQuery.setParentIds(TreeHelper.getQueryParentIds(id));
        return this.find(sysMenuQuery);
    }
    ...
    public List<SysMenu> findByUserId(@NotNull Integer userId) {
        ...
        List<SysMenu> all = this.find(sysMenuQuery);
